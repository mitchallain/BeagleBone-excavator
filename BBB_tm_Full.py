...
# BBB_tm_Full.py
#
# Receive joystick positions from the server at MacBook, 
# and create PWM servo signals for boom, arm, bucket, and swing
#
# NOTE: Architecture needs to be planned and optimized
#
